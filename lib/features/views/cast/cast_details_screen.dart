                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 10),
                            Text('PRODUCING', style: AppTextStyle.largeHeadingFranchise),
                          ],
                        ),
                        const SizedBox(height: 16),

                        // Producing Credit Items
                        _buildCreditItem(
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 10),
                            Text('DIRECTING', style: AppTextStyle.largeHeadingFranchise),
                          ],
                        ),
                        const SizedBox(height: 16),

                        // Directing Credit Items
                        _buildCreditItem(
