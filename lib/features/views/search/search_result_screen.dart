...
import 'package:woke_movie_rating/features/widgets/custom_background.dart'; // import your reusable background
...
class _SearchResultScreenState extends State<SearchResultScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomBackground( // <-- Use the reusable background
      child: Scaffold(
        ...
        body: CustomScrollView(
          ...
          slivers: [
            ...
            SliverAppBar(
              ...
              flexibleSpace: CustomBackground( // <-- Use the same background inside AppBar
                child: SafeArea(
                  child: Stack(
                    children: [
